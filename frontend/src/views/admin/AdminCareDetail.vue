...
import { careOfId, getCare, updateCare } from '/src/use/useCare'
...
const content = ref('')
onMounted(async () => {
   const care = await getCare(props.care_id)
   content.value = care.content
})
const saveContent = async () => {
   await updateCare(props.care_id, { content: content.value })
}
