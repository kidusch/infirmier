...
const title = computed(() => localTitle.value || legislation.value.title)
app.service('legislation').on('update', legislation => {
   localTitle.value = legislation.title
})
...
const content = computed(() => localContent.value || legislation.value.content)
app.service('legislation').on('update', legislation => {
   localContent.value = legislation.content
})
